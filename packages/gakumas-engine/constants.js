...
export const ALL_FIELDS = [
  ...
  "noActiveTurns",
  "noMentalTurns",
  "noGoodConditionTurnsTurns",
  "noConcentrationTurns",
  "noGoodImpressionTurnsTurns",
  "noMotivationTurns",
  "noStrengthTurns",
  "noFullPowerChargeTurns",
  "poorConditionTurns",
  "uneaseTurns",
  "slumpTurns",
  "scoreBuffs",
...
export const EOT_DECREMENT_FIELDS = [
  ...
  S.noActiveTurns,
  S.noMentalTurns,
  S.noGoodConditionTurnsTurns,
  S.noConcentrationTurns,
  S.noGoodImpressionTurnsTurns,
  S.noMotivationTurns,
  S.noStrengthTurns,
  S.noFullPowerChargeTurns,
  S.uneaseTurns,
  S.slumpTurns,
  S.noCardUseTurns,
];
